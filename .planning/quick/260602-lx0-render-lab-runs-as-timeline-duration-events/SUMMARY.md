...
- Replaced run-card subtitle protocol text with the run time range.
- Applied completed-step strikethrough to both step title and step detail text.
...
- Re-ran `make preflight`, `git diff --check`, and simulator launch after the subtitle and strikethrough update.
